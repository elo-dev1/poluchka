...
const CHANCE_CARDS = [
  ...
  {
    id: 'ch_13',
    title: 'Дед Мороз оставил дачу 🎅',
    text: 'Неожиданный подарок! Вы получаете случайную свободную недвижимость бесплатно без права отказа.',
...
const CHEST_CARDS = [
  ...
  },
  {
    ...
    text: 'Дальний родственник завещал вам имущество! Вы получаете случайную свободную недвижимость бесплатно без права отказа.',
    type: 'random_free_property',
    icon: '📜'
  }
];
