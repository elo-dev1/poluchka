          ...
          <Tabs defaultValue={defaultTab} className="w-full">
            ...
            <div className="overflow-y-auto max-h-[50vh] pr-2 mt-4 text-xs leading-relaxed text-muted-foreground text-left flex flex-col gap-3">
              ...
              <TabsContent value="terms" className="flex flex-col gap-3 mt-0">
                ...
                <h5 className="font-bold text-foreground mt-1">5. Интеллектуальная собственность и товарные знаки</h5>
                <p>5.1. Игра «Получка» является независимой многопользовательской онлайн-стратегией и не является продуктом компании Hasbro Inc. Товарные знаки «Monopoly» и «Монополия» принадлежат Hasbro Inc. Вся графика, названия активов, пиктограммы и программный код являются оригинальными авторскими разработками.</p>
                <p>5.2. Игровые механики не подлежат авторскому праву (ст. 1259 ГК РФ). Все возможные названия, городские отсылки или пародийные элементы в тематических режимах используются исключительно в развлекательных, сатирических и пародийных целях в порядке свободного использования (ст. 1274 ГК РФ).</p>

                <h5 className="font-bold text-foreground mt-1">6. Возрастная классификация (436-ФЗ)</h5>
                <p>6.1. В соответствии с Федеральным законом № 436-ФЗ «О защите детей от информации, причиняющей вред их здоровью и развитию» Сервису присвоена возрастная категория <strong>16+</strong>.</p>
              </TabsContent>
