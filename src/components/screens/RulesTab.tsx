  ...
  const modesRules: ModeRuleGuide[] = [
    {
      ...
      icon: Crown,
      summary:
        'Официальные правила экономической игры «Получка». Полный периметр 11x11, 28 активов (22 объекта недвижимости в 8 цветовых группах, 4 транспортные линии и 2 сервиса) и турнирная партия до банкротства соперников.',
      chips: [
        { icon: Globe, label: 'Поле', value: '40 клеток (11x11)' },
        { icon: Building2, label: 'Активы', value: '22 объекта в 8 группах' },
      ...
      sections: [
        ...
        {
          title: 'Монополии и развитие недвижимости',
          icon: Building2,
          color: 'text-blue-400',
          items: [
            'Владение всеми объектами одной цветовой группы дает статус Монополии и удваивает базовую прибыль незастроенных активов.',
            'При наличии монополии разрешается строить до 4 домов/филиалов и 1 отель/комплекс на каждом объекте группы.',
            'Строительство ведется строго равномерно: нельзя поставить 2-й дом на один объект, пока на остальных не стоит по 1-му дому.',
            'Полноценный отель/комплекс приносит максимальную арендную плату, способную разорить любого конкурента.',
          ],
        },
        {
          title: 'Транспортные линии и инфраструктурные сервисы',
          icon: Train,
          color: 'text-emerald-400',
          items: [
            'На поле расположено 4 Транспортные линии. Оплата проезда растет с числом станций во владении: 1 линия = $25, 2 линии = $50, 3 = $100, все 4 = $200.',
            'Инфраструктурные сервисы взимают плату в размере броска кубиков: 4x от очков кубиков (при 1 сервисе) или 10x (при владении обоими сервисами).',
          ],
        },
        {
          ...
          items: [
            'При нехватке наличных для оплаты счетов игрок может заложить свободные объекты банку за 50% номинальной стоимости.',
            'Заложенный актив не приносит прибыль, пока не будет выкуплен обратно с 10% банковской комиссией.',
            'Перед залогом объекта все построенные на нем улучшения должны быть проданы банку за половину цены.',
    ...
    },
    {
      ...
      icon: Flame,
      summary:
        'Ускоренный формат на компактном поле 7x7. По 2 объекта в каждой группе, моментальный сбор монополий и быстрая партия без затяжных ожиданий.',
      chips: [
        { icon: Globe, label: 'Поле', value: '24 клетки (7x7)' },
        { icon: Building2, label: 'Объекты', value: '14 (по 2 в группе)' },
        { icon: Zap, label: 'Монополия', value: 'Всего 2 объекта' },
      ...
      sections: [
        {
          ...
          items: [
            ...
            'В каждой группе теперь всего по 2 объекта: монополия собирается в два раза быстрее, чем в классике.',
        ...
        },
        {
          ...
          items: [
            ...
            'Ошибки в Блице наказываются жестче: одна остановка на застроенном отеле или комплексе мгновенно решает исход партии.',
          ],
        },
        {
          ...
          color: 'text-emerald-400',
          items: [
            'Стремитесь выкупить оба объекта первой попавшейся группы и сразу развить их 2–3 филиалами.',
            'Не копите пассивные деньги — пустые наличные быстро сгорают под налогами и рентой конкурентов.',
            'Используйте аукционы: забирайте нужные объекты, пока соперники экономят бюджет.',
          ],
        },
      ],
    },
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            ...
            'Залог объектов ради завершения ключевого развития — классический дуэльный прием победителей.',
          ],
        },
      ],
    },
    {
      ...
      sections: [
        ...
        },
        {
          ...
          color: 'text-amber-400',
          items: [
            'Рента за попадание на чужой объект уходит БАНКУ, а не владельцу! Владелец не обогащается от чужих шагов.',
      ...
      sections: [
        {
          ...
          items: [
            ...
            'Все расходы (покупка объектов, постройка филиалов, штрафы) списываются из общей казны дуэта.',
            'Вся поступающая арендная плата от соперников мгновенно пополняет общий баланс команды.',
          ],
        },
        {
          title: 'Бесплатное посещение объектов напарника ($0)',
          icon: Check,
          color: 'text-emerald-400',
          items: [
            'Остановка на объекте союзника абсолютно БЕСПЛАТНА: никакой платы между напарниками.',
            'Объекты союзника служат надежным островком безопасности на враждебной доске.',
          ],
        },
        {
          ...
          color: 'text-amber-400',
          items: [
            'Если у одного напарника объект №1, а у второго — объект №2 той же группы, это признается ПОЛНОЙ МОНОПОЛИЕЙ команды!',
            'Любой из напарников в свой ход может развивать объекты монополии постройками за счет общей казны.',
